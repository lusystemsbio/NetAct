...
download.file(url, destfile="GSE63310_RAW.tar", mode="wb") 
untar("GSE63310_RAW.tar", exdir = ".")
...
Su K, et al (2022) NetAct: a computational platform to construct core transcription factor regulatory networks using gene activity, bioRxiv 2022.05.06.487898; doi: https://doi.org/10.1101/2022.05.06.487898
